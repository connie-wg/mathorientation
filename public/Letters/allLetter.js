const allLetters = [
    ...
    {
        section: 4,
        advice: 'Do a lot of practice before you actually speak to an interviewer. Don\'t panic, you only need one job. Networking is also needed, especially when you would like to work in some finance-related companies.'
    },
    {
        section: 5,
    ...
    {
        section: 7,
        advice: 'If you\'re shy like I was in first year, you really just gotta push yourself to talk to people. You\'d be surprised, most people sitting alone in the caf for example really do enjoy people that reach out and have a conversation with them. It might be rough at first, but the more you do something the better you get at it. And trust me, it\'s really rewarding :D'
    },
    {
        section: 1,
