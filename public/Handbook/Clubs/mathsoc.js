const mathSocText = {
    ...
    text: 
        <div>
            <p>
            The Mathematics Society (MathSoc) is the student-run society for all Mathematics students at the University of Waterloo (including Computer Science and Software Engineering students). 
            The office is located on the 3rd floor of the Mathematics and Computing Building (MC) in room 3038. Student volunteers manage the office and all members of the society are students.
            </p>
            <p>
            ...
            <p>
            Check out the <a href="https://mathsoc.uwaterloo.ca/">MathSoc website</a>!  
            </p>
        </div>,
    subsections: []
}

export default mathSocText;